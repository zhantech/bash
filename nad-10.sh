...
# Clone Tree
git clone https://github.com/NusantaraROM-Devices/device_xiaomi_santoni.git -b 10 device/xiaomi/santoni
git clone https://github.com/zhantech/android_kernel_xiaomi_santoni.git -b luuvy-4.9 kernel/xiaomi/msm8937
git clone https://github.com/NusantaraROM-Devices/vendor_xiaomi_santoni.git -b 10 vendor/xiaomi/
